...
#import "CodeCustomViewController.h"

#import "CustomTextView.h"

@interface CodeCustomViewController () <SwpTextViewDelegate>

@property (nonatomic, strong) CustomTextView *textView;

@end

@implementation CodeCustomViewController
