 ...
 *  @author swp_song
 *
 *  @brief  swpTextView:text: ( SwpTextView 代理方法，用户输入文字变化调用 )
 *
 ...
 */
- (__kindof SwpTextView * _Nonnull (^)(UIColor *))borderColor;
 ...
 */
- (__kindof SwpTextView * _Nonnull (^)(UIColor *))swpTextViewBackgroundColor;
 ...
 */
- (__kindof SwpTextView * _Nonnull (^)(SwpTextViewTextChangeBlock _Nullable))swpTextViewChangeChain;
